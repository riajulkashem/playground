...
export default function handler(req, res) {
    ...
    const tempFilePath = `/tmp/temp_c_script_${uuidv4()}.c`;
    const tempExecPath = `/tmp/temp_c_script_${uuidv4()}`;
    ...
    fs.writeFile(tempFilePath, code, (writeErr) => {
        ...
        // Compile the C file
        exec(`gcc ${tempFilePath} -o ${tempExecPath}`, (compileErr, stdout, stderr) => {
            if (compileErr) {
